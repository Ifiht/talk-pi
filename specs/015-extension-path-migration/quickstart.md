...
2. Update the active extension root references to `/.pi/agent/extension/talk-pi`.
...
Validation note: repository code and active documentation now use `/.pi/agent/extension/talk-pi`; remaining `/.pi/tools` mentions are limited to migration/spec history. Targeted path-resolution and startup tests passed.
